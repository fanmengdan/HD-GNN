...
def read_data(self, step):
    ...
    E_edge = np.zeros((100, self.Dr, self.Nr),
    ...
    C_edge = np.zeros((100, self.Dr, self.HNr),
    ...
    if not os.path.exists(dir):
       ...
       with open(r'./Intermediate_products/Esc_data_' + str(step) + '.pkl', 'wb') as f11:
           joblib.dump(Esc_data, f11)
           # pkl.dump(Esc_data, f11)

       with open(r'./Intermediate_products/Etc_data_' + str(step) + '.pkl', 'wb') as f12:
           joblib.dump(Etc_data, f12)
           # pkl.dump(Etc_data, f12)

    else:
       # Esc_data = pkl.load(open(r'./Intermediate_products/Esc_data_' + str(step) + '.pkl', 'rb'))
       # Etc_data = pkl.load(open(r'./Intermediate_products/Etc_data_' + str(step) + '.pkl', 'rb'))
       Esc_data = joblib.load(open(r'./Intermediate_products/Esc_data_' + str(step) + '.pkl', 'rb'))
       Etc_data = joblib.load(open(r'./Intermediate_products/Etc_data_' + str(step) + '.pkl', 'rb'))
