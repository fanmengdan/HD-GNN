...
parser.add_argument('--epoch', type=int, default=50, help='number of training epochs') # 5000
...
parser.add_argument('--HNo', type=int, default=94, help='The Number of Objects') # 74, 114, 150
parser.add_argument('--Nr', type=int, default=62250, help='The Number of Relations') # 39800, 62250, 62250
parser.add_argument('--HNr', type=int, default=8742, help='The Number of Relations') # 5402, 12882, 22350
